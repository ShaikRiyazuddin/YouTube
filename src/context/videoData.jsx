...
export const VideoData = ({children}) =>{
    ...
    const fetch = () =>{
        axios.get(`https://youtube.googleapis.com/youtube/v3/search?q=${"latest"}&type=video&chart=mostPopular&regionCode=IN&key=${key}&maxResults=20&part=snippet`).then(res => {
